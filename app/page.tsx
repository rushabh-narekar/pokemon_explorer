      ...
      <section className="hero-shell">
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="font-display mt-4 text-3xl font-bold tracking-tight sm:text-5xl">
            Discover Pokémon, search the catalog, and save your favorites.
          </h1>
          <p className="mt-4 text-base leading-8 text-white/90 sm:text-lg">
            Browse species, view stats and artwork, and build a personal list of Pokémon you love.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link href="/pokemon" className="btn-primary">
              Browse catalog
            </Link>
            <Link href="/favorites" className="btn-secondary !border-white !bg-white/10 !text-white hover:!bg-white/20">
              View favorites
            </Link>
          </div>
        </div>
      ...
      <section aria-labelledby="featured-heading">
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-muted">Popular picks to get you started.</p>
          </div>
          <Link href="/pokemon" className="btn-ghost hidden sm:inline-flex">
            View all
          </Link>
        </div>
